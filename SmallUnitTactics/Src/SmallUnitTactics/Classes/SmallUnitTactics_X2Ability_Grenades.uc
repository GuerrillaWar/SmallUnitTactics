...
static function X2AbilityTemplate PrimeGrenade()
{
	...
	local X2Condition_AbilitySourceWeapon   GrenadeCondition, ProximityMineCondition;
	local X2Effect_ProximityMine            ProximityMineEffect;
  local SmallUnitTactics_Effect_PrimedGrenade PrimedGrenadeEffect;

	`CREATE_X2ABILITY_TEMPLATE(Template, 'SUT_PrimeGrenade');	
	...
	PrimedGrenadeEffect = new class'SmallUnitTactics_Effect_PrimedGrenade';
